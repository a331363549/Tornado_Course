...
create table ih_user_profile(
  ...
  up_admin tinyint NOT NULL DEFAULT '0' COMMENT '是否为管理员：0：不是，1：是',
...
create table ih_house_info(
  ...
  hi_price int unsigned NOT NULL DEFAULT '0' COMMENT '房屋价格，单位：分',
  ...
  hi_house_uint varchar(32) NOT NULL DEFAULT '' COMMENT '房屋户型',
  hi_capacity int unsigned NOT NULL DEFAULT '1' COMMENT '容纳人数',
  hi_beds varchar(64) NOT NULL DEFAULT '' COMMENT '床的配置',
  hi_deposit int unsigned NOT NULL DEFAULT '0' COMMENT '押金，单位：分',
  ...
  hi_online_status tinyint unsigned NOT NULL DEFAULT '0' COMMENT '0：下线，1：上线',
...
create table  ih_house_facility(
  ...
  hf_facility_id bigint unsigned NOT NULL COMMENT '房屋设施',
...
create table ih_order_info(
  oi_oder_id bigint unsigned NOT NULL AUTO_INCREMENT COMMENT '订单id',
  ...
  oi_house_price int unsigned NOT NULL COMMENT '房屋单价 单位 分',
  oi_amount int unsigned NOT NULL COMMENT '订单金额：单位 分',
  oi_status tinyint NOT NULL DEFAULT '0' COMMENT '订单状态，0-待接待，1-待支付，2-已支付，3-待评价，4-已完成，5-已取消，6-拒接单',
  oi_comment text NULL COMMENT '订单评论',
  oi_utim datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
  oi_ctime datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (oi_oder_id),
